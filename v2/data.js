...
(function () {
  ...
  const USERS = [
    ...
    { id: 'u_kumar',  name: 'S. Kumar',       role: 'lab_manager',    title: 'Enrichment Lab Manager',     species: [],                                                 seed: 405, email: 's.kumar@zooenrich.in',  phone: '+91 98400 55667', canPurchase: true,  approverId: 'u_admin', siteId: 'site_hyd', additionalSites: ['site_mum','site_che'], imgQ: 'professional portrait headshot person smile' },
  ...
  const REVIEWS = [
    ...
    /* Extra reviews for prod_001 (Burlap Scent Sack) — to populate the
       View-all overlay with at least 20+ entries for demo. */
    { id:'rv_013', productId:'prod_001', buyerId:'u_iyer',  stars:5, text:'Catnip scent kept our jaguars engaged for 50 minutes. Ordering bulk.',                          createdAt:'2026-04-22T10:15:00.000Z' },
    { id:'rv_014', productId:'prod_001', buyerId:'u_farah', stars:4, text:'Solid build. Stitching could be tighter — one sack split after a week.',                       createdAt:'2026-04-20T08:00:00.000Z' },
    { id:'rv_015', productId:'prod_001', buyerId:'u_rao',   stars:5, text:'Tigers chewed through it slowly — gave us a great enrichment session.',                        createdAt:'2026-04-18T14:30:00.000Z' },
    { id:'rv_016', productId:'prod_001', buyerId:'u_das',   stars:3, text:'Average. Macaques lost interest after 15 minutes. Better for big cats.',                        createdAt:'2026-04-16T11:00:00.000Z' },
    { id:'rv_017', productId:'prod_001', buyerId:'u_kumar', stars:5, text:'Excellent value for money. We rotate three of these every week.',                              createdAt:'2026-04-14T09:45:00.000Z' },
    { id:'rv_018', productId:'prod_001', buyerId:'u_joshi', stars:4, text:'Smell faded after two days outside. Indoors it lasted a full week.',                           createdAt:'2026-04-12T16:00:00.000Z' },
    { id:'rv_019', productId:'prod_001', buyerId:'u_iyer',  stars:5, text:'Lions tore in within seconds. Definitely top-tier scent enrichment.',                          createdAt:'2026-04-11T10:30:00.000Z' },
    { id:'rv_020', productId:'prod_001', buyerId:'u_rao',   stars:2, text:'Two sacks arrived empty — looked like a packaging issue.',                                     createdAt:'2026-04-09T08:20:00.000Z', vendorReply:{ text:'Sincere apologies — we are shipping replacements today and tightening QC.', at:'2026-04-10T07:00:00.000Z' } },
    { id:'rv_021', productId:'prod_001', buyerId:'u_farah', stars:5, text:'Great for our cheetahs — the catnip+jute combo is irresistible.',                              createdAt:'2026-04-07T12:45:00.000Z' },
    { id:'rv_022', productId:'prod_001', buyerId:'u_das',   stars:4, text:'Reusable after a wash. Add a hanging loop and it would be perfect.',                           createdAt:'2026-04-05T15:10:00.000Z' },
    { id:'rv_023', productId:'prod_001', buyerId:'u_kumar', stars:5, text:'Snow leopards picked them apart slowly — exactly the engagement we wanted.',                   createdAt:'2026-04-03T09:00:00.000Z' },
    { id:'rv_024', productId:'prod_001', buyerId:'u_joshi', stars:3, text:'Fine product, but our enclosure crew prefers the bigger XL size.',                             createdAt:'2026-04-01T13:20:00.000Z' },
    { id:'rv_025', productId:'prod_001', buyerId:'u_iyer',  stars:5, text:'Caracals sniffed and rolled for almost an hour. Great find.',                                  createdAt:'2026-03-30T11:00:00.000Z' },
    { id:'rv_026', productId:'prod_001', buyerId:'u_farah', stars:4, text:'Reliable enrichment staple. Add a stronger scent variant please.',                             createdAt:'2026-03-28T10:00:00.000Z' },
    { id:'rv_027', productId:'prod_001', buyerId:'u_rao',   stars:5, text:'Used during a cub-introduction session — cubs took to it immediately.',                        createdAt:'2026-03-26T15:00:00.000Z' },
    { id:'rv_028', productId:'prod_001', buyerId:'u_das',   stars:1, text:'Got mouldy after monsoon storage. Be careful with humidity.',                                  createdAt:'2026-03-24T09:30:00.000Z', vendorReply:{ text:'Storing in sealed containers fixes this — we will add a note to the packaging.', at:'2026-03-25T08:00:00.000Z' } },
    { id:'rv_029', productId:'prod_001', buyerId:'u_kumar', stars:5, text:'A staple in our enrichment programme. Restock arrived in two days.',                            createdAt:'2026-03-22T14:00:00.000Z' },
    { id:'rv_030', productId:'prod_001', buyerId:'u_joshi', stars:5, text:'Cheap, effective, animals love it. What more do you want?',                                    createdAt:'2026-03-20T11:30:00.000Z' },
    { id:'rv_031', productId:'prod_001', buyerId:'u_iyer',  stars:4, text:'Pleasant aroma in the lab while assembling. Animals respond well too.',                        createdAt:'2026-03-18T16:00:00.000Z' },
    { id:'rv_032', productId:'prod_001', buyerId:'u_farah', stars:5, text:'Great for keeper-led enrichment workshops. Easy to refill.',                                   createdAt:'2026-03-16T10:00:00.000Z' },
    { id:'rv_033', productId:'prod_001', buyerId:'u_rao',   stars:4, text:'Matches the spec. Burlap could be coarser for stronger scent diffusion.',                       createdAt:'2026-03-14T09:15:00.000Z' },
    { id:'rv_034', productId:'prod_001', buyerId:'u_das',   stars:5, text:'Otters dragged them around the pool — repurposed beautifully.',                                createdAt:'2026-03-12T13:45:00.000Z' },
    { id:'rv_035', productId:'prod_001', buyerId:'u_kumar', stars:5, text:'Reliable, consistent quality across multiple orders.',                                          createdAt:'2026-03-10T11:00:00.000Z' },
    { id:'rv_036', productId:'prod_001', buyerId:'u_joshi', stars:3, text:'Decent. Wish there were unscented variants for sensitive species.',                            createdAt:'2026-03-08T15:30:00.000Z' },
    { id:'rv_037', productId:'prod_001', buyerId:'u_iyer',  stars:5, text:'Bears tossed and rolled in the burlap. Strong recommend for ursids.',                          createdAt:'2026-03-06T08:30:00.000Z' },
    { id:'rv_038', productId:'prod_001', buyerId:'u_farah', stars:4, text:'Long shelf life when sealed. We keep a buffer of 20 in storage.',                              createdAt:'2026-03-04T12:00:00.000Z' }
  ];
